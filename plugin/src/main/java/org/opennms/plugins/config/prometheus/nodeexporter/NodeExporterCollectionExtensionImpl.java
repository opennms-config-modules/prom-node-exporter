...
public class NodeExporterCollectionExtensionImpl implements SnmpCollectionExtension {

    private final ClasspathSnmpDataCollectionLoader snmpDataCollectionLoader =
            new ClasspathSnmpDataCollectionLoader(NodeExporterCollectionExtensionImpl.class,
